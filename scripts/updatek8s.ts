...
async function main() {
    ...
    await replaceLineInFile('examples/helm/blockchainETL/Chart.yaml', 'version: ', 'version: ' + newVersion);
    await replaceLineInFile('examples/helm/blockchainETL/values.yaml', '  version: ', '  version: ' + newVersion);
