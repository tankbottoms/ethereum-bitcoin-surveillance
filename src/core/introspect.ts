...
export async function introspectTargetNodePlatform(
  ...
  if (typeof adapter.initialize === 'function') {
    ...
    try {
      ...
      const msg = e instanceof Error ? e.message : 'general error';
      warn('Failed to initialize node platform adapter:', msg);
      ...
      try {
        ...
        error('Failed to initialize generic node platform adapter:', err);
      }
